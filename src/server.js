...
/**
 * Metrics API endpoint (simple - no auth for standalone use)
 */
...
/**
 * Demo call endpoint
 * Initiates an outbound call to user's phone with custom business name
 ...
 * Uncomment these if you need multi-tenant management features
 */
// Prompts management
